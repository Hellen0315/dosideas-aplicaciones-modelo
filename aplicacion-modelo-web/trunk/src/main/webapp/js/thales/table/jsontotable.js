...
function CreateTableView(objArray, theme, tableId, enableHeader) {
    // set optional theme parameter
    if (theme === undefined) {
        theme = 'display'; //default theme
    }
    ...
    var str = '<table class="' + theme + '" cellpadding="0" cellspacing="0" border="0" id="'+ tableId +'">';
