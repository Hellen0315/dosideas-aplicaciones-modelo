package com.dosideas.demoweb.controller;

import com.dosideas.demoweb.exception.RecursoNoEncontradoException;
import com.dosideas.demo1.service.ExamenService;
...
public class PaisController {
    ...
    public @ResponseBody void buscarPorId(@PathVariable Long id) throws RecursoNoEncontradoException {

        if (true) {
            throw new RecursoNoEncontradoException("Pais no encontrado");
        }
    }
